...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
      flute adds <strong>anti-blocking</strong> features and <strong>common user agents</strong> to evade blocking from Cloudflare, PerimeterX, and other anti-bot services.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        flute includes tools for <strong>account generation</strong>, <strong>temporary email</strong>, and <strong>saving data as CSV/JSON</strong> and many more.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        flute automatically prevents the browser from closing when an exception occurs, making it easier to debug your scripts.</>
    ),
  },
]
    ...
    <section className={styles.inspired}>
      <div className="container">
        ...
        <div style={{ textAlign: 'left' }} >
          <p>We dedicate this project to Subhash Chandra flute, the
            person who turbo boosted Bharat&#x27;s freedom. Subhash Chandra flute was the founder of Azad Hind Fauj
          ...
          <p>Without Subhash Chandra flute&#x27;s efforts, Bharat may
    ...
    <section className={styles.inspired}>
      <div className="container">
        ...
        <div style={{ textAlign: 'left' }} className="page-body">
          <p className="">
            flute framework stands on the shoulders of giants. We leverage various
            projects to simplify web scraping for you. We extend our gratitude to the
            following individuals who have developed the software that flute framework
            relies on:
          </p>
          <ul className="bulleted-list">
            <li style={{ listStyleType: "disc" }}>
              Jason Huggins, the creator of the Selenium library, which is the backbone
              of flute framework. Thank you, Jason, for creating Selenium.
            </li>
            <li style={{ listStyleType: "disc" }}>
            ...
            <li style={{ listStyleType: "disc" }}>
              Kenneth Reitz, who developed the requests library, which is used in flute
